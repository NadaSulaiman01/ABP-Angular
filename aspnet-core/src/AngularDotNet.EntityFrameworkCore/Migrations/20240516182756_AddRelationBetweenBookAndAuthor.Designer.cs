...
{
    [DbContext(typeof(AngularDotNetDbContext))]
    [Migration("20240516182756_AddRelationBetweenBookAndAuthor")]
    partial class AddRelationBetweenBookAndAuthor
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AngularDotNet.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("AngularDotNet.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AngularDotNet.Books.Book", b =>
                {
                    b.HasOne("AngularDotNet.Authors.Author", null)
                        .WithMany()
